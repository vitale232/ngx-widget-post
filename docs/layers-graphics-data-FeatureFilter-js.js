...
See https://js.arcgis.com/4.18/esri/copyright.txt for details.
*/
const t=_core_Logger_js__WEBPACK_IMPORTED_MODULE_0__["default"].getLogger("esri.views.2d.layers.features.support.whereUtils"),a={getAttribute:(e,r)=>e.field(r)};async function s(e,s){const n=await __webpack_require__.e(/*! import() | core-sql-WhereClause-js */ "default~arcade-featureSetUtils-js~arcade-functions-featuresetbase-js~arcade-functions-featuresetgeom~0707428b").then(__webpack_require__.bind(null, /*! ../../../../../core/sql/WhereClause.js */ "ZqIb"));try{const o=n.WhereClause.create(e,s);if(!o.isStandardized){const e=new _core_Error_js__WEBPACK_IMPORTED_MODULE_1__["default"]("mapview - bad input","Unable to apply filter's definition expression, as expression is not standardized.",o);t.error(e)}return e=>{const r=e.readArcadeFeature();return o.testFeature(r,a)}}catch(r){return t.warn("mapview-bad-where-clause","Encountered an error when evaluating where clause",e),e=>!0}}
