...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getExtentForScale", function() { return o; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getResolutionForScale", function() { return r; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getScale", function() { return e; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getScaleForResolution", function() { return i; });
/* harmony import */ var _core_unitUtils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../core/unitUtils.js */ "gEht");
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.18/esri/copyright.txt for details.
*/
function e(e,r){const i=r||e.extent,o=e.width,c=Object(_core_unitUtils_js__WEBPACK_IMPORTED_MODULE_0__["getMetersPerUnitForSR"])(i&&i.spatialReference);return i&&o?i.width/o*c*_core_unitUtils_js__WEBPACK_IMPORTED_MODULE_0__["inchesPerMeter"]*96:0}function r(e,r){return e/(Object(_core_unitUtils_js__WEBPACK_IMPORTED_MODULE_0__["getMetersPerUnitForSR"])(r)*_core_unitUtils_js__WEBPACK_IMPORTED_MODULE_0__["inchesPerMeter"]*96)}function i(e,r){return e*(Object(_core_unitUtils_js__WEBPACK_IMPORTED_MODULE_0__["getMetersPerUnitForSR"])(r)*_core_unitUtils_js__WEBPACK_IMPORTED_MODULE_0__["inchesPerMeter"]*96)}function o(t,n){const e=t.extent,i=t.width,o=r(n,e.spatialReference);return e.clone().expand(o*i/e.width)}
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "I3SMaterialDefinition", function() { return a; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "I3SMaterialPBRMetallicRoughness", function() { return l; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FetchAssociatedFeatureLayer", function() { return c; });
/* harmony import */ var _core_maybe_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../core/maybe.js */ "srIe");
...
See https://js.arcgis.com/4.18/esri/copyright.txt for details.
*/
class c{constructor(t,r,e){this.parsedUrl=t,this.portalItem=r,this.signal=e,this.rootDocument=null;const a=this.parsedUrl.path.match(/^(.*)\/SceneServer\/layers\/([\d]*)\/?$/i);a&&(this.urlParts={root:a[1],layerId:parseInt(a[2],10)})}async fetch(){var r;if(!this.urlParts)return null;const e=null!=(r=this.portalItem)?r:await this.portalItemFromServiceItemId();if(Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__["isNone"])(e))return this.loadFromUrl();const a=await this.findAndLoadRelatedPortalItem(e);return Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__["isNone"])(a)?null:this.loadFeatureLayerFromPortalItem(a)}async fetchPortalItem(){var r;if(!this.urlParts)return null;const e=null!=(r=this.portalItem)?r:await this.portalItemFromServiceItemId();return Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__["isNone"])(e)?null:this.findAndLoadRelatedPortalItem(e)}async fetchRootDocument(){if(Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__["isSome"])(this.rootDocument))return this.rootDocument;if(Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__["isNone"])(this.urlParts))return this.rootDocument={},{};const e={query:{f:"json"},responseType:"json",authMode:"no-prompt",signal:this.signal},a=`${this.urlParts.root}/SceneServer`;try{const t=await Object(_request_js__WEBPACK_IMPORTED_MODULE_3__["default"])(a,e);this.rootDocument=t.data}catch{this.rootDocument={}}return this.rootDocument}async fetchServiceOwningPortalUrl(){var t;const r=null==(t=_kernel_js__WEBPACK_IMPORTED_MODULE_2__["id"])?void 0:t.findServerInfo(this.parsedUrl.path);if(null!=r&&r.owningSystemUrl)return r.owningSystemUrl;const a=this.parsedUrl.path.replace(/(.*\/rest)\/.*/i,"$1")+"/info";try{const t=(await Object(_request_js__WEBPACK_IMPORTED_MODULE_3__["default"])(a,{query:{f:"json"},responseType:"json",signal:this.signal})).data.owningSystemUrl;if(t)return t}catch(t){Object(_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_1__["throwIfAbortError"])(t)}return null}async findAndLoadRelatedPortalItem(t){try{return(await t.fetchRelatedItems({relationshipType:"Service2Service",direction:"reverse"},{signal:this.signal})).find((t=>"Feature Service"===t.type))||null}catch(t){return Object(_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_1__["throwIfAbortError"])(t),null}}async loadFeatureLayerFromPortalItem(t){await t.load({signal:this.signal});const r=await this.findMatchingAssociatedSublayerUrl(t.url);return new _FeatureLayer_js__WEBPACK_IMPORTED_MODULE_6__["default"]({url:r,portalItem:t}).load({signal:this.signal})}async loadFromUrl(){const t=await this.findMatchingAssociatedSublayerUrl(`${this.urlParts.root}/FeatureServer`);return new _FeatureLayer_js__WEBPACK_IMPORTED_MODULE_6__["default"]({url:t}).load({signal:this.signal})}async findMatchingAssociatedSublayerUrl(t){const r=t.replace(/^(.*FeatureServer)(\/[\d]*\/?)?$/i,"$1"),e={query:{f:"json"},responseType:"json",authMode:"no-prompt",signal:this.signal},o=this.urlParts.layerId,n=this.fetchRootDocument(),i=Object(_request_js__WEBPACK_IMPORTED_MODULE_3__["default"])(r,e),[l,c]=await Object(_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_1__["all"])([i,n]),u=c&&c.layers,h=l.data&&l.data.layers;if(!Array.isArray(h))throw new Error("expected layers array");if(Array.isArray(u))for(let t=0;t<Math.min(u.length,h.length);t++){if(u[t].id===o)return`${r}/${h[t].id}`}else if(o<h.length)return`${r}/${h[o].id}`;throw new Error("could not find matching associated sublayer")}async portalItemFromServiceItemId(){const t=(await this.fetchRootDocument()).serviceItemId;if(!t)return null;const a=new _portal_PortalItem_js__WEBPACK_IMPORTED_MODULE_5__["default"]({id:t}),o=await this.fetchServiceOwningPortalUrl();Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__["isSome"])(o)&&(a.portal=new _portal_Portal_js__WEBPACK_IMPORTED_MODULE_4__["default"]({url:o}));try{return a.load({signal:this.signal})}catch(t){return Object(_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_1__["throwIfAbortError"])(t),null}}}
